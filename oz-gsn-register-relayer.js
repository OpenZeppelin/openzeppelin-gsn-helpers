...
program
  ...
  .option('--unstakeDelay <delay>', 'time to wait between deregistering and withdrawing the stake, in seconds (defaults to one week)')
  .option('--funds <funds>', 'amount to transfer to the relayer to pay for relayed transactions, in wei (defaults to 5 Ether)')
